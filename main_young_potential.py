...
from scraper_young_potential import PMScraper
import pandas as pd
import gspread
...
SHEET_NAME = "Young Potential"  # Sheet tab name
...
def main():
    ...
    print("Starting Young Potential scraper...")
    scraper = PMScraper()
    try:
        ...
        if username and password and username != "your_username":
            ...
            print("Saved all results to transfer_targets_young_potential.csv")
